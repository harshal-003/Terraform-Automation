...
[server]
$INSTANCE_IP ansible_user=ubuntu ansible_ssh_private_key_file=/home/harshal/Downloads/my-key.pem
EOL
...
ssh -o StrictHostKeyChecking=no -i /home/harshal/Downloads/my-key.pem ubuntu@$INSTANCE_IP <<EOF
    ...
    sudo docker run -d -p 80:80 --name portfolio-container harshal001/myportfolio:latest
